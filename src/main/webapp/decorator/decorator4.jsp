...
<body class="animsition" style="padding-top: 0px;">
									...
									<li><div class="cate_list">
											<div class="cate_main_sub">
												<div class="cate_main">
													<ul>
														...
														<li class="cate_main_notclick" id="toy"><a
															...
															href="../item/list.store?category=1">토이</a></li>
														<li class="cate_main_notclick" id="cloth"><a
															style="font-size: 17px;"
															href="../item/list.store?category=2">의류</a></li>
														<li class="cate_main_notclick" id="tech"><a
															style="font-size: 17px;"
															href="../item/list.store?category=3">생활 테크</a></li>
													</ul>

												</div>
												<ul id="all_ul" style="display: none;">
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;" href="../item/list.store?sort=1">인기
															순</a></li>
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;" href="../item/list.store?sort=2">리뷰
															순</a></li>
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;" href="../item/list.store?sort=3">신상품
															순</a></li>
												</ul>
												<ul id="toy_ul" style="display: none;">
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;"
														href="../item/list.store?category=1&subcategory=1">미니
															인형</a></li>
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;"
														href="../item/list.store?category=1&subcategory=2">중형
															인형</a></li>
													<!-- <li class="cate_sub_notclick"><a
												...
												<ul id="cloth_ul" style="display: none;">
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;"
														href="../item/list.store?category=2&subcategory=1">여성</a></li>
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;"
														href="../item/list.store?category=2&subcategory=2">남성</a></li>
													<!-- <li class="cate_sub_notclick"><a
												...
												<ul id="tech_ul" style="display: none;">
													...
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;"
														href="../item/list.store?category=3&subcategory=1">에어팟
															케이스</a></li>
													<li class="cate_sub_notclick"><a
														style="font-size: 17px;"
														href="../item/list.store?category=3&subcategory=2">에어팟
															액세서리</a></li>
												</ul>
							...
							<li class="active-menu"><a href="../mypage/myindex.store"
								...
								<ul class="sub-menu deco7_hamburger_list"
									...
									<c:if test="${empty sessionScope.loginUser}">
										<li>
											<div style="width: 90%;" id="h">
												<a href="../mypage/orderlistpage.store" class="no"
													id="ll_b_de"> 주문내역 </a>
											</div>
										</li>
									</c:if>
									...
									<c:if test="${empty sessionScope.loginUser}">
										<li>
											<div style="width: 90%;" id="h">
												<a href="../mypage/contactpage.store" class="no"
													id="ll_b_de"> 1:1문의 </a>
											</div>
										</li>
									</c:if>
									...
									<li>
										<div style="width: 90%;" id="h">
											<a href="../nonmember/nonmember.store" id="ll_b_de">비회원
												주문조회</a>
										</div>
									</li>
								</ul></li>
	...
	<section class="bg0 p-b-140"
		style="padding-top: 3%; padding-bottom: 10%;">
		<!--     <div class="container"> -->
		<decorator:body />
