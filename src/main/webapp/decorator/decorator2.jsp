...
<body class="animsition" style="padding-top: 0px;">
   ...
   <header>
					...
					<div class="menu-desktop" style="width: 30%;">
						<ul class="main-menu" id="lightfont_black_de">
							<li class="active-menu"><a href="product/list.store">카테고리
									<img src="../images/index_deco/ico-header-triangle.png" width="7" height="4">
							</a>
								<ul class="sub-menu" style="position: absolute;">
									<li>
										<div style="width: 90%;" id="h">
											<a href="../product/list.store" style="border-right: 1px solid rgba(0, 0, 0, 0.2);">전체</a>
										</div>
									</li>
									<li>
										<div style="width: 90%;" id="h">
											<a href="../product/list.store" style="border-right: 1px solid rgba(0, 0, 0, 0.2);">토이</a>
										</div>
									</li>
								</ul>
								<ul class="sub-menu" style="position: absolute; margin-left: 225px;">
									<li>
										<div style="width: 90%;" id="h">
											<a href="../product/list.store" style="border-right: 1px solid rgba(0, 0, 0, 0.2);">전체</a>
										</div>
								...
								<ul class="sub-menu" style="position: absolute; margin-left: 450px;">
									<li>
										<div style="width: 90%;">
											<a href="../product/list.store"> 
											<img height="60" width="60" src="../images/index_deco/character/category_rion_off.png" onmouseout="this.src='../images/index_deco/character/category_rion_off.png'" onmouseover="this.src='../images/index_deco/character/category_rion_on.png'">
												<img height="60" width="60" src="../images/index_deco/character/category_apeach_off.png" onmouseout="this.src='../images/index_deco/character/category_apeach_off.png'" onmouseover="this.src='../images/index_deco/character/category_apeach_on.png'">
											</a>
										</div>
									</li>
									<li>
										<div style="width: 90%;">
											<a href="../product/list.store"> <img height="60" width="60" src="../images/index_deco/character/category_rion_off.png" onmouseout="this.src='../images/index_deco/character/category_rion_off.png'" onmouseover="this.src='../images/index_deco/character/category_rion_on.png'">
												<img height="60" width="60" src="../images/index_deco/character/category_apeach_off.png" onmouseout="this.src='../images/index_deco/character/category_apeach_off.png'" onmouseover="this.src='../images/index_deco/character/category_apeach_on.png'">
											</a>
										</div>
									</li>
      ...
      <div class="wrap-header-mobile" style="width: 100%;">
			<!-- Button show menu -->
			<div style="width: 8%;" class="btn-show-menu-mobile hamburger hamburger--squeeze">
				<span class="hamburger-box"> <span class="hamburger-inner"></span>
				</span>
			</div>
			<div style="width: 4%;" class="icon-header-item cl2 hov-cl1 trans-04 js-show-modal-search">
			...
			<div style="width: 4%;" class="icon-header-item cl2 hov-cl1 trans-04 icon-header-noti js-show-cart">
				<i class="zmdi zmdi-shopping-cart"></i>
			</div>
		</div>
	<hr style="margin-top: 0.01%; margin-bottom: 0.01%;">
      ...
      <!-- Menu Mobile -->
      <div class="menu-mobile" style="position: fixed; top: 0px; left: 0px; right: 0px; bottom: 0px; background-color: white; 
    ...
    overflow-x: auto; text-align:center;">
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							...
							<img width="60" src="../images/index_deco/character/category_rion_off.png" onmouseout="this.src='../images/index_deco/character/category_rion_off.png'" onmouseover="this.src='../images/index_deco/character/category_rion_on.png'">
							<br>
							라이언
							</a>
							</div>
					...
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							<div style="display: inline-block;">
							<a href="product/list.store" style="border: 1px solid transparent; font-size: 18px;" id="lightfont_black_de">
							<img width="60" src="../images/index_deco/character/category_apeach_off.png" onmouseout="this.src='../images/index_deco/character/category_apeach_off.png'" onmouseover="this.src='../images/index_deco/character/category_apeach_on.png'">
							<br>
							어피치
							</a>
							</div>
					...
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							<div style="display: inline-block;">
							<a href="product/list.store" style="border: 1px solid transparent; font-size: 18px;" id="lightfont_black_de">
							<img width="60" src="../images/index_deco/character/category_muzi_off.png" onmouseout="this.src='../images/index_deco/character/category_muzi_off.png'" onmouseover="this.src='../images/index_deco/character/category_muzi_on.png'">
							<br>
							무지
							</a>
							</div>
					...
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							<div style="display: inline-block;">
							<a href="product/list.store" style="border: 1px solid transparent; font-size: 18px;" id="lightfont_black_de">
							<img width="60" src="../images/index_deco/character/category_frodo_off.png" onmouseout="this.src='../images/index_deco/character/category_frodo_off.png'" onmouseover="this.src='../images/index_deco/character/category_frodo_on.png'">
							<br>
							프로도
							</a>
							</div>
					...
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							<div style="display: inline-block;">
							<a href="product/list.store" style="border: 1px solid transparent; font-size: 18px;" id="lightfont_black_de">
							<img width="60" src="../images/index_deco/character/category_neo_off.png" onmouseout="this.src='../images/index_deco/character/category_neo_off.png'" onmouseover="this.src='../images/index_deco/character/category_neo_on.png'">
							<br>
							 네오
							</a>
							</div>
					...
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							<div style="display: inline-block;">
							<a href="product/list.store" style="border: 1px solid transparent; font-size: 18px;" id="lightfont_black_de">
							<img width="60" src="../images/index_deco/character/category_tube_off.png" onmouseout="this.src='../images/index_deco/character/category_tube_off.png'" onmouseover="this.src='../images/index_deco/character/category_tube_on.png'">
							<br>
							 튜브
							</a>
							</div>
					...
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							<div style="display: inline-block;">
							<a href="product/list.store" style="border: 1px solid transparent; font-size: 18px;" id="lightfont_black_de">
							<img width="60" src="../images/index_deco/character/category_jayz_off.png" onmouseout="this.src='../images/index_deco/character/category_jayz_off.png'" onmouseover="this.src='../images/index_deco/character/category_jayz_on.png'">
							<br>
							 제이지
							</a>
							</div>
					...
					<div class="right-top-bar" style="
						...
						" id="lightfont_black_de">
							<div style="display: inline-block;">
							<a href="product/list.store" style="border: 1px solid transparent; font-size: 18px;" id="lightfont_black_de">
							<img width="60" src="../images/index_deco/character/category_con_off.png" onmouseout="this.src='../images/index_deco/character/category_con_off.png'" onmouseover="this.src='../images/index_deco/character/category_con_on.png'">
							<br>
							 콘
							</a>
							</div>
		...
		<li style="height: 50px; background-color: white;
    			   ...
    			   border-bottom: 1px solid rgb(242, 242, 242);
    			   padding: 10px;" id="lightfont_black_de">
			...
			<div class="container-search-header">
				...
				">
					<div class="flex-c-m trans-04">
						<input class="plh3" type="text" name="search" placeholder="무엇을 찾으세요?">
					</div>
					<br> 
					...
					<div class="scroll-wrap-y">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store">
							<img src="../images/index_deco/mobile/search-apeach.png">
							</a>
						</div>
					  	</div>
					  	<div class="liroll_character">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store">
							<img src="../images/index_deco/mobile/search-con.png">
							</a>
						</div>
					  	</div>
					  	<div class="liroll_character">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store" style="border: 1px solid transparent;  font-size: 18px;" id="lightfont_black_de">
							<img src="../images/index_deco/mobile/search-frodo.png">
							</a>
							</div>
					  	</div>
					  	<div class="liroll_character">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store" style="border: 1px solid transparent;  font-size: 18px;" id="lightfont_black_de">
							<img src="../images/index_deco/mobile/search-jayg.png">
							</a>
							</div>
					  	</div>
					  	<div class="liroll_character">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store" style="border: 1px solid transparent;  font-size: 18px;" id="lightfont_black_de">
							<img src="../images/index_deco/mobile/search-muzi.png">
							</a>
							</div>
					  	</div>
					  	<div class="liroll_character">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store" style="border: 1px solid transparent;  font-size: 18px;" id="lightfont_black_de">
							<img src="../images/index_deco/mobile/search-neo.png">
							</a>
							</div>
					  	</div>
					  	<div class="liroll_character">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store" style="border: 1px solid transparent;  font-size: 18px;" id="lightfont_black_de">
							<img src="../images/index_deco/mobile/search-ryan.png">
							</a>
							</div>
					  	</div>
					  	<div class="liroll_character">
						...
						" id="lightfont_black_de">
							<a href="../product/list.store" style="border: 1px solid transparent;  font-size: 18px;" id="lightfont_black_de">
							<img src="../images/index_deco/mobile/search-tube.png">
							</a>
							</div>
					  	</div>
					 </div>
