...
<body>
	...
	<span id="my_b_b" style="color: navy; display: inline-block;">관리자&nbsp;</span>회원가입 승인 페이지</div>
	<div class="admin_list_no">
		<ul class="admin_list_no_ul">
			...
			<li class="admin_email" id="my_ll_b">이메일</li>
		...
		<div class="order_list1">
			...
			<div class="admin_img" id="my_l_b">
				<span><img style="width: 100%; height: auto;"
					src="../images/product/category_rion_off.png" alt="프로필"> </span>
			</div>
			<!-- 관리자 id -->
			<div class="order_list_content" id="my_l_b"
					style="padding-top: 20px;">
				<div class="admin_id">
					<span style="font-size: 15px;">박하영<br>(hyp3221)
					</span>
				</div>
			</div>
			<!-- 관리자 email -->
			...
			<div class="admin_gender" id="my_l_b">
				<span class="admin_gender"
					style="display: inline-block; font-size: 15px;">여자</span>
			</div>
			<!-- 관리자 가입 신청일 -->
