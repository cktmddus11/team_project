	...
	<div id="order_item_list">
		<form class="order_item_list_padding">
			...
			<div class="recipient_info_chk">
				<div>
					<div class="order_info" id="my_l_b">
						받으시는분 <input type="text" class="order_info_list_chk" value="박하영"
							readonly />
					</div>
					<div class="order_info" id="my_l_b">
						주소 <input class="order_info_list_chk" value="서울시 은평구 진관동 aa동 bbb호"
							readonly />
					</div>
					<div class="order_info" id="my_l_b">
						전화번호 <input class="order_info_list_chk" value="010-1234-5678"
							readonly />
					</div>
					<div class="order_info" id="my_l_b">
						이메일 <input class="order_info_list_chk" value="hyp3221@naver.com"
							readonly />
					</div>
				</div>
			</div>
			<div class="order_continue_or_break">
				...
				&nbsp;&nbsp; <input type="button" value="주문내역확인" id="order my_l_b"
					class="jWeebG">
			</div>
		</form>
	</div>
