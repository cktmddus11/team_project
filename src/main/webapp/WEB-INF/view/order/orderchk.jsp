			...
			<div class="recipient_info_chk">
				<div>
					<div class="order_info" id="my_l_b">
						<span id="my_l_b">받으시는분</span>&nbsp;
						<input class="order_info_list_chk" value="박하영" readonly />
					</div>
					<div class="order_info" id="my_l_b">
						<span id="my_l_b">주소</span>&nbsp;
						<input class="order_info_list_chk" value="서울시 은평구 진관동 aa동 bbb호" readonly />
					</div>
					<div class="order_info" id="my_l_b">
						<span id="my_l_b">전화번호</span>&nbsp;
						<input class="order_info_list_chk" value="010-1234-5678" readonly />
					</div>
					<div class="order_info" id="my_l_b">
						<span id="my_l_b">이메일</span>&nbsp;
