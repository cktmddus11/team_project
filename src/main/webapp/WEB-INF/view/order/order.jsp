			...
			<c:if test='${empty sessionScope.loginUser}'>
				...
				<div class="select_item_list" style="height: 243;">
					<div style="margin-bottom: 40px;">
						<ul>
									...
									<li class="select_item_list1">
										<div class="select_item_list1_img">
											...
											<div class="item_option">
												...
												<!-- <p class="space_p"></p> -->
												<span class="item_option2" id="my_l_b"> <span><fmt:formatNumber
															pattern="#,###원" value="${cart.price * cart.quantity}" /></span>
												</span> <span class="quantity_chk" id="my_l_b"> <span>/${cart.quantity}개</span>
												</span>
											</div>
							...
							<c:if test="${sessionScope.CART.itemSetList==null }">
								<c:forEach var="cart" items="${orderitems}" varStatus="stat">
									<input type="hidden" name="itemnum"
										value="${cart.item.itemnum}">
									<li class="select_item_list1">
										<div class="select_item_list1_img">
						...
						<ul class="listinfo_total_price">
							<li class="total_info"><strong class="total_price"
								...
								<p class="total_price_1" id="my_ll_b">
									<span id="my_ll_b"><fmt:formatNumber value="${tot}"
											pattern="#,###원" /></span>
								</p></li>
							<!-- <li class="total_info"><strong class="total_price"
							...
							<li class="total_info"><strong class="total_price"
								...
								<p class="total_price_1" id="my_bb_b" style="font-size: 22px;">
									<span id="my_bb_b"><fmt:formatNumber value="${tot}"
											pattern="#,###원" /></span>
								</p></li>
						</ul>
					</div>
				...
				<div class="recipient_info_chk">
					<div>
							...
							<div class="question-form__InputWrapper-sc-14728i7-16 cCjyDE">
								<div class="input-text__InputTextWrap-sc-14n8vry-0 eJxDUH">
									<form:input class="input-text__CustomText-sc-14n8vry-1 llGwgt"
										id="my_ll_b" placeholder="이름 입력" error="0" align="left"
										padding="15" path="username" value="" style="width: 100%;" />
									<form:errors path="username" cssClass="my_ll_r" element="div" />
								</div>
							</div>
						</div>
						<div class="question-form__InputBlock-sc-14728i7-13 dgNTux">
							<span class="question-form__InputLabel-sc-14728i7-14 jcHywt"
								id="my_ll_b">전화번호</span>
							<div class="question-form__InputWrapper-sc-14728i7-16 cCjyDE">
								<div class="input-text__InputTextWrap-sc-14n8vry-0 eJxDUH">
									<form:input class="input-text__CustomText-sc-14n8vry-1 llGwgt"
										id="my_ll_b" placeholder="번호 입력" error="0" align="left"
										padding="15" path="phonenum" value="" style="width: 100%;" />
									<form:errors path="phonenum" cssClass="my_ll_r" element="div" />
								</div>
							</div>
						</div>
						<div class="question-form__InputBlock-sc-14728i7-13 dgNTux">
							...
							<div class="question-form__InputWrapper-sc-14728i7-16 cCjyDE">
								<div class="input-text__InputTextWrap-sc-14n8vry-0 eJxDUH">
									<form:input
										class="input-text__CustomText-sc-14n8vry-1 llGwgt my_ll_b"
										placeholder="이메일" error="0" align="left" padding="15"
										path="userid" value="" style="width: 100%;" />
									<form:errors path="userid" cssClass="my_ll_r" element="div" />
								</div>
							</div>
						</div>
						...
						<div class="question-form__InputBlock-sc-14728i7-13 dgNTux">
							<span class="question-form__InputLabel-sc-14728i7-14 jcHywt"
								id="my_ll_b">나머지 주소</span>
							<div class="question-form__InputWrapper-sc-14728i7-16 cCjyDE">
								<div class="input-text__InputTextWrap-sc-14n8vry-0 eJxDUH">
									<form:input class="input-text__CustomText-sc-14n8vry-1 llGwgt"
										id="my_ll_b" placeholder="나머지 주소" error="0" align="left"
										padding="15" path="restaddress" value="" style="width: 100%;" />
								...
								<li class="select_item_list1">
									<div class="select_item_list1_img">
										...
										<div class="item_option">
											...
											<!-- <p class="space_p"></p> -->
											<span class="item_option2" id="my_ll_b"> <span><fmt:formatNumber
					...
					<div>
							...
							<div class="question-form__InputWrapper-sc-14728i7-16 cCjyDE">
								<div class="input-text__InputTextWrap-sc-14n8vry-0 eJxDUH">
									<form:input class="input-text__CustomText-sc-14n8vry-1 llGwgt"
										...
										style="width: 100%;"
										readonly="${!empty sessionScope.loginUser?'true':'false'}" />
						...
						<div class="question-form__InputBlock-sc-14728i7-13 dgNTux">
							...
							<div class="question-form__InputWrapper-sc-14728i7-16 cCjyDE">
								<div class="input-text__InputTextWrap-sc-14n8vry-0 eJxDUH">
									<form:input class="input-text__CustomText-sc-14n8vry-1 llGwgt"
										id="my_ll_b" placeholder="이메일" error="0" align="left"
										padding="15" path="userid"
										value="${sessionScope.loginUser.userid}" style="width: 100%;"
										readonly="${!empty sessionScope.loginUser?'true':'false'}" />
							...
							<div class="topay_1">
								<ul class="topay_space">
									<li class="pay_list_space pay_list_space_all"><strong
										...
										<div class="order_item_price_all order_item_price">
											<span id="my_ll_b"> <fmt:formatNumber value="${tot}"
													pattern="#,###원" /> <input type="hidden" value="${tot }"
												id="fn_type1_price">
											</span>
										</div></li>
									...
									<li class="pay_list_space pay_list_space_all"><strong
										class="point pay_info_list" id="my_ll_b">포인트 <span
											class="point_op" id="my_ll_b"> (<fmt:formatNumber
													value="${sessionScope.totalpoint }" pattern="#,###P" />)
										</span>
									</strong>
										<div class="point_bank">
											<span id="my_ll_b" style="font-size: 22px;"> <input
												name="usepoint" type="text" class="my_ll_b"
									...
									<li class="pay_list_space"><strong
										...
										<div class="final_order_price1 order_item_price_all"
											id="my_bb_b">
											<span id="my_bb_b"> <input type="text"
												style="text-align: right;" id="fn_total"
												value="<fmt:formatNumber value="${tot}" pattern="#,###"/>"
												name="totprice" class="my_bb_b" readonly="readonly"
												name="usepoint" />원
					...
					<div class="pay_select">
						...
						<div class="all_bank_info">
							<div class="input_bank_info">
								<div class="bank_div">
									<span class="input_bank">입금은행</span> <span class="bank_account">국민은행:
										807-24-0257-128 [박하영]</span>
								</div>
							</div>
							<div class="input_bank_info">
								<div class="bank_div">
									<span class="input_bank">입금자명</span> <span class="bank_account">
