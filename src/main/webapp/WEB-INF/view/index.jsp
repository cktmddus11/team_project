					...
					<div class="main_block_list" style="">
							...
							<article class="main_section_item">
								...
								<ul class="main_section_item_ul" itemtype="new">
									<c:forEach var="newitemlist" items="${newitemlist}"
										varStatus="stat">
										<li class="main_section_item_li" itemtype="new"><input
											hidden="itemnum" value="${newitemlist.itemnum}">
											<div>
												...
												</span> <strong class="item_title" itemtype="new"> <a
														href="item/product_detail.store?no=${newitemlist.itemnum}"
														style="color: black">${newitemlist.itemname}</a></strong>
													<p class="item_price" itemtype="new">
														<span class="item_price_sp">금액</span> <span><fmt:formatNumber
																value="${newitemlist.price}" type="currency"
																currencySymbol="" /></span>원
													</p>
													<div class="bycDdO"></div>
												</a>
												<div class="wish_check" itemtype="new">
													<input id="new_item${stat.index}" type="checkbox"
														data-toggle="tooltip" data-placement="top"
														onclick="checkclick(${newitemlist.pickno}, ${newitemlist.itemnum}, 'new_item${stat.index}')"
														title="찜하기"
														<c:if test="${newitemlist.pickno != 0}">checked="checked"</c:if>>
													<label for="new_item${stat.index}"></label> <input
														type="hidden" name="pickno" value="${newitemlist.pickno}">
												</div>
											</div></li>
									</c:forEach>
								</ul>
						...
						<div class="wish_block" aria-hidden="false" data-swipeable="true"
							...
							<article class="main_section_item">
								...
								<!-- 아이템 목록 -->
								<ul class="main_section_item_ul" itemtype="new">
									<c:forEach var="pitemlist" items="${pitemlist}"
										varStatus="stat">
										<li class="main_section_item_li" itemtype="new"><input
											hidden="itemnum" value="${pitemlist.itemnum}">
											<div>
												<a style="display: block;" href="item/product-detail.store">
													<span class="item_sp" itemtype="new"> <span
														class="item_sp_imgsp"> <img class="item_sp_img"
														...
														href="item/product_detail.store?no=${pitemlist.itemnum}"
														style="color: black;"> ${pitemlist.itemname} </a></strong>
													<p class="item_price" itemtype="new">
												...
												<div class="wish_check" itemtype="new">
													<input id="p_item${stat.index}" type="checkbox"
														data-toggle="tooltip"
														onclick="checkclick(${pitemlist.pickno}, ${pitemlist.itemnum},  'p_item${stat.index}')"
														data-placement="top" title="찜하기"
														<c:if test="${pitemlist.pickno!=0}">checked="checked"</c:if>>
													<label for="p_item${stat.index}"></label> <input
														type="hidden" name="pickno" value="${pitemlist.pickno}">
												</div>
											</div></li>
									</c:forEach>
								</ul>
						...
						<div class="all_block" aria-hidden="false" data-swipeable="true"
							...
							<article class="main_section_item">
								...
								<!-- 아이템 목록 -->
								<ul class="main_section_item_ul" itemtype="new">
									<c:forEach var="allitemlist" items="${allitemlist}"
										varStatus="stat">
										<li class="main_section_item_li" itemtype="new"><input
											hidden="itemnum" value="${allitemlist.itemnum}">
											<div>
												<a style="display: block;" href="item/product-detail.store">
													<span class="item_sp" itemtype="new"> <span
														class="item_sp_imgsp"> <img class="item_sp_img"
														...
														href="item/product_detail.store?no=${allitemlist.itemnum}"
														style="color: black"> ${allitemlist.itemname}</a></strong>
													<p class="item_price" itemtype="new">
														<span class="item_price_sp">금액</span> <span><fmt:formatNumber
																value="${allitemlist.price}" type="currency"
																currencySymbol="" /></span>원
													</p>
													<div class="bycDdO"></div>
												</a>
												<div class="wish_check" itemtype="new">
													<input id="all_item${stat.index}" type="checkbox"
														data-toggle="tooltip" data-placement="top"
														onclick="checkclick(${allitemlist.pickno}, ${allitemlist.itemnum},  'all_item${stat.index}')"
														title="찜하기"
														<c:if test="${allitemlist.pickno != 0}">checked="checked"</c:if>>

													<label for="all_item${stat.index}"></label> <input
														type="hidden" name="pickno" value="${allitemlist.pickno}">
