	...
	<form:form modelAttribute="storeinfo" action="store_update.store"
		...
		<div class="store_write_body">
			<div class="store_write_edit">
				<div class="store_write_input">
					...
					<div class="input_storename"
						...
						<input type="text" class="storename" id="my_ll_b"
							placeholder="매장 이름을 입력하세요" name="storename"
							value="${storeinfo.storename }">

					</div>
				</div>
				<form:errors path="storename" cssClass="my_ll_r"
				...
				<div class="store_write_input">
					...
					<div class="input_storename"
						...
						<c:if test="${!empty storeinfo.storepic}">
							<div id="file_desc">
								&nbsp;
								<button class="btn_cancel" id="my_ll_b"
									style="border: 1px solid transparent;"
									onclick="file${storeinfo.storepic}">${storeinfo.storepic}</button>
								<button class="btn_cancel" id="my_ll_b" style="height: 40px;"
									onclick="javascript:file_delete()">첨부파일삭제</button>
							</div>
						</c:if>
						<form:hidden path="picfile" />
						<input type="file" class="storename" id="my_ll_b"
							placeholder="사진을 첨부하세요" name="picfile"
							value="${storeinfo.picfile }">
					</div>
				</div>
				<div class="store_write_input">
				...
				<form:errors path="storetel" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
				<div class="store_write_input">
				...
				<form:errors path="storetime" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
				<div class="store_write_input">
					...
					<div class="input_storename"
						...
						<input type="text" class="storename" id="my_ll_b"
							...
							value="${storeinfo.storeadd }">
					</div>
				</div>
				<form:errors path="storeadd" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
				<div class="store_write_input">
				...
				<form:errors path="mapurl" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
				<div class="store_write_input">
				...
				<form:errors path="mapiframe" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
			</div>
		</div>
