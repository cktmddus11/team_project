...
<body>
	<form:form modelAttribute="storeinfo" action="store_write.store"
		name="f" enctype="multipart/form-data" method="post">
			...
			<div class="store_write_edit">
				<div class="store_write_input">
					...
					<div class="input_storename"
						...
						<form:input class="storename" path="storename" id="my_ll_b"
