		...
		<div class="admin_order_header">
			...
			<div class="admin_list_no">
				...
				<ul class="admin_list_no_ul">
					<li class="store_name" id="my_bb_b" style="font-size: 20px;">매장
						이름</li>
					<li class="store_pic" id="my_bb_b" style="font-size: 20px;">매장
						사진</li>
					<li class="store_tel" id="my_bb_b" style="font-size: 20px;">전화
						번호</li>
					<li class="store_time" id="my_bb_b" style="font-size: 20px;">영업
						시간</li>
				...
				<c:forEach var="store" items="${storelist }">
					<ul class="order_list1">
						<li class="store_list"><a onclick="return false;"
							style="padding-left: 0; color: black; width: 16vw;"> <span
								class="order_list1_span">매장 이름</span> <span
								class="order_list1_num" id="my_ll_b">${store.storename }</span>
						</a></li>
						<hr class="moblie_line">
						<li class="store_list" style="width: 11vw;"><img
						...
						<li class="store_list" style="text-align: center; width: 3vw;">
							<div class="order_list2_date" id="my_ll_w"
								...
								<button class="admin_store_update" style="padding-left: 0;"
									id="my_ll_w" onclick="location.href='${store.mapurl}'">
									확인</button>
							</div>
						</li>
						<li class="order_list4_2" style="text-align: center; width: 3vw;">
							<div class="order_list2_state" id="my_ll_b"
								...
								<br class="desktop_br"> <br class="desktop_br">
								<button class="admin_store_update" id="my_ll_w"
