...
<body>
	<div class="store_write_header" id="my_b_b">[관리자]환불/교환/반품 신청서 정보
		확인</div>
			...
			<div class="store_write_input">
				...
				<div class="input_storename"
					...
					<input type="datetime" class="storename " id="my_ll_b"
						...
						value="<fmt:formatDate value="${chg.chg_orderdate }" pattern="yyyy-MM-dd"/>">
				</div>
			</div>
			<div class="store_write_input">
			...
			<div class="store_write_input">
				...
				<div class="input_checkname"
					...
					<input style="float: left; margin: 0.3vw;" type="radio"
						class="checkname"
						<c:if test="${chg.chg_reseon=='고객변심' }">checked</c:if>
						name="chg_reseon" value="고객변심" disabled="disabled">
					<div id="my_ll_g" style="height: 100%; float: left; margin: 0.3vw;">고객변심</div>
				</div>
				<div class="input_checkname"
					style="border: 1px solid white; float: left;">
					<input style="float: left; margin: 0.3vw;" type="radio"
						class="checkname" name="chg_reseon"
						<c:if test="${chg.chg_reseon=='상품불량' }">checked</c:if>
						value="상품불량" disabled="disabled">
				...
				<div class="input_checkname"
					...
					<input style="float: left; margin: 0.3vw;" type="radio"
						class="checkname"
						<c:if test="${chg.chg_reseon=='오배송' }">checked="checked"</c:if>
						name="chg_reseon" value="오배송" disabled="disabled">
				...
				<div class="input_checkname"
					...
					<input style="float: left; margin: 0.3vw;" type="radio"
						class="checkname"
						<c:if test="${chg.chg_reseon=='상품파손' }">checked="checked"</c:if>
						name="chg_reseon" value="상품파손" disabled="disabled">
