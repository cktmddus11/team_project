...
<body>
	...
	<div class="product-register">
		<span class="product_register_div1">[관리자]고객센터 <c:if
				...
				test="${help.boardcode == 1}">공지사항 </c:if>글수정
		</span>
	</div>
	...
	<form:form modelAttribute="help" action="help_update.store"
		...
		<div class="product-name">
			...
			<div class="input-name">
				<div class="input-text-name">
					<form:input type="password" class="i-t-name" placeholder="비밀번호"
						error="0" align="left" padding="15" path="password" value=""
						id="my_ll_b" />
				...
				<c:if test="${!empty help.qnafileurl}">
					<div id="file_desc">
						...
						<button class="btn_cancel" id="my_ll_b"
							style="max-width: fit-content; border: 1px solid transparent;"
							onclick="images/${help.qnafileurl}">${help.qnafileurl}</button>
