						...
						<div class="dropdown"
							...
							<div class="select">
								<span id="my_ll_b"> 
									...
									<c:if test="${!empty param.selectvalue}">${param.selectvalue}</c:if>
								</span> 
					...
					<c:forEach var="item" items="${itemlist}">
						...
						<ul class="order_list1">
							...
							<li class="item_name_2"
								...
								<a href="../item/product_detail.store?no=${item.itemnum}"> <span
									id="my_ll_b"> ${item.itemname} </span>
							</a>
							</li>
							<li class="out_num_2"
								style="text-align: center; margin-top: 1.5vw; width: 15vw;">
								<span id="my_ll_b"> <fmt:formatDate
										value="${item.regdate}" pattern="yyyy-MM-dd" />
							</span>
							</li>
							<li class="out_num_2"
								style="text-align: center; margin-top: 1.5vw; width: 10vw;">
