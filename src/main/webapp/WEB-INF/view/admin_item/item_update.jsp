...
<body>
	<form:form modelAttribute="item"
		action="item_update.store?itemnum=${item.itemnum}"
		...
		<div class="product-name">
			...
			<div class="input-name" id="my_ll_b">
				<c:if test="${!empty item.itemfile1url}">
					<div id="file_desc">
						<button class="btn_cancel_1" id="my_ll_b"
			...
			<div class="input-name" id="my_ll_b">
				<c:if test="${!empty item.itemfile2url}">
					<div id="file_desc">
						...
						<button class="btn_cancel" id="my_ll_b" style="height: 40px;"
							onclick="javascript:file_delete1()">첨부파일삭제</button>
					</div>
				</c:if>
			...
			<div class="input-name" id="my_ll_b">
				<c:if test="${!empty item.itemfile3url}">
					<div id="file_desc">
						...
						<button class="btn_cancel" id="my_ll_b" style="height: 40px;"
							onclick="javascript:file_delete2()">첨부파일삭제</button>
					</div>
				</c:if>
