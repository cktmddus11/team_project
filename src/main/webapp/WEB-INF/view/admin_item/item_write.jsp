...
<body>
	<form:form modelAttribute="item" action="item_write.store"
		...
		<div class="product-name">
			...
			<div class="input-name">
				<form:select class="select-box" style="padding-left: 0.8vw;"
					path="category" id="my_ll_b">
					<option id="my_ll_b" value="${param.category}">상위 카테고리 선택</option>
				</form:select>

				<div class="input-name">
					<form:select class="select-box" style="padding-left: 0.8vw;"
						path="subcategory" id="my_ll_b">
						<option id="my_ll_b" value="${param.subcategory}">하위 카테고리
							선택</option>
					</form:select>
		...
		<div class="product-name">
			...
			<div class="input-name">
				<div class="input-text-name">
					<form:input class="i-t-name" id="my_ll_b" placeholder="상품명"
						error="0" align="left" padding="15" path="itemname" value="" />
			...
			<div class="input-name">
				<div class="input-text-name">
					<input type="password" class="i-t-name" id="my_ll_b"
						placeholder="비밀번호" error="0" align="left" padding="15"
						name="password"> <font color="red"><form:errors
							path="password" /></font>
		...
		<div class="product-name">
			...
			<div class="input-name">
				<div class="input-text-name">
					<form:input class="i-t-name" id="my_ll_b" placeholder="상품가격"
						error="0" align="left" padding="15" path="price" value="" />
