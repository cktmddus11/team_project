	...
	<form:form modelAttribute="chg" action="change_return_order.store"
		...
		<div class="store_write_body">
			<div class="store_write_edit">
				...
				<form:errors path="chg_tel" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
				<div class="store_write_input">
				...
				<form:errors path="chg_account" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
				<div class="store_write_input">
				...
				<form:errors path="chg_detail" cssClass="my_ll_r"
					cssStyle="padding-left:7vw;" element="div" />
			</div>
		</div>
		<div class="store_write_footer">
			<div class="btn_block">
				...
				<input class="btn_save" id="my_bb_w" type="submit"
					style="text-align: center;" value="등록">
			</div>
		</div>
	</form:form>
</body>
