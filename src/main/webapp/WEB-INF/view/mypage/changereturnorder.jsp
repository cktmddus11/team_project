...
<body>
	<form:form modelAttribute="chg" action="changereturnorder.store"
		...
		<div class="store_write_body">
			<div class="store_write_edit">
				<div class="store_write_input">
					...
					<div class="input_storename"
						...
						<input type="text" class="storename my_ll_b" id="input_ch_re"
							placeholder="주문번호를 입력하세요" name="chg_orderno" value="">
					</div>
				</div>
				...
				<div class="store_write_input">
					...
					<div class="input_storename"
						style="border: 1px solid rgb(227, 229, 232);">
						<input type="date" class="storename my_ll_b" id="input_ch_re"
							placeholder="주문날짜를 입력하세요" name="chg_orderdate" value="">
					</div>
				</div>
				...
				<div class="store_write_input">
					...
					<div class="input_storename"
						style="border: 1px solid rgb(227, 229, 232);">
						<input type="text" class="storename my_ll_b" id="input_ch_re"
							placeholder="연락처를 입력하세요" name="chg_tel" value="">
					</div>
				</div>
				...
				<div class="store_write_input">
					...
					<div class="input_storename"
						style="border: 1px solid rgb(227, 229, 232);">
						<input type="text" class="storename my_ll_b" id="input_ch_re"
							placeholder="상품명을 입력하세요" name="chg_itemname" value="">
					</div>
				</div>
				...
				<div class="store_write_input">
					...
					<div class="input_checkname"
						...
						<input style="float: left; margin: 0.3vw;" type="radio"
							class="checkname" name="chg_reseon" value="고객변심">
						<div id="my_ll_g"
					...
					<div class="input_checkname"
						style="border: 1px solid white; float: left;">
						<input style="float: left; margin: 0.3vw;" type="radio"
							class="checkname" name="chg_reseon" value="상품불량">
						<div id="my_ll_g"
					...
					<div class="input_checkname"
						style="border: 1px solid white; float: left;">
						<input style="float: left; margin: 0.3vw;" type="radio"
							class="checkname" name="chg_reseon" value="오배송">
						<div id="my_ll_g"
					...
					<div class="input_checkname"
						style="border: 1px solid white; float: left;">
						<input style="float: left; margin: 0.3vw;" type="radio"
							class="checkname" name="chg_reseon" value="상품파손">
						<div id="my_ll_g"
				...
				<div class="store_write_input">
					...
					<div class="input_storename"
						...
						<textarea class="storename" id="my_ll_b" rows="15"
							placeholder="상세 사유를 입력하세요" name="chg_detail"></textarea>
					</div>
				</div>
